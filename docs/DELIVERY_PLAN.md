...
- **Текущая работа:** согласовать OpenSpec change `build-first-signal-evaluation-skeleton` с точным контрактом одного end-to-end сценария на записанном входе.
- **Следующая операционная работа:** после принятия change пропустить записанный provider fixture через первый полный исследовательский путь.
...
| ID | Статус | Рабочий пакет |
|---|---|---|
| 2.1 | Current | Согласовать OpenSpec change `build-first-signal-evaluation-skeleton` с точным контрактом одного end-to-end сценария. |
