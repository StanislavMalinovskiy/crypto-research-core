...
| ADR | Status | Decision |
|---|---|---|
| [0001](0001-modular-monolith.md) | Accepted / topology superseded | One Spring Modulith modular monolith |
| [0002](0002-spring-data-jdbc.md) | Accepted | Spring Data JDBC and `JdbcClient` |
| [0003](0003-synchronous-java-25-baseline.md) | Superseded | Original synchronous Java 25 preview baseline |
...
| [0007](0007-stable-java-25-baseline.md) | Accepted | Stable Java 25 lifecycle without preview features |
| [0008](0008-six-module-mvp-topology.md) | Accepted | Six product-shaped MVP modules and exact dependency DAG |
| [0009](0009-research-reproducibility.md) | Accepted | UTC time, exact arithmetic, provenance and deterministic research evidence |
