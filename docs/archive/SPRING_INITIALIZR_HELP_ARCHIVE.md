# Spring Initializr help (archive)

> **Status:** generated historical reference from the initial project scaffold. It is not a source of architecture or dependency decisions; use the root `README.md`, `AGENTS.md` and current `docs/` sources instead.

# Read Me First
The following was discovered as part of building this project:

* The original generated package name `io.cryptoresearch.crypto-research-core` was invalid. The current project package root is `io.cryptoresearch`.
